...
import com.example.song.musicplayer.local.PlayListsActivity.PublicTools;
import com.example.song.musicplayer.local.PlayListsActivity.VideoWorkItem;
...
//            mStopFlag = (ImageView)convertView.findViewById(R.id.video_stop);
