package com.example.song.musicplayer.local;
...
import com.example.song.musicplayer.local.DisplayListAdapter.ViewHolder;
...
import com.example.song.musicplayer.util.UserPreference;
import com.example.song.musicplayer.widget.MainTitlebar;
import cn.waps.AppConnect;

import com.example.song.musicplayer.R;
//import com.example.song.musicplayer.widget.MyListView;
...
public class PlayListsActivity extends BaseActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		((MainTitlebar)findViewById(R.id.main_title)).show("本地视频");
		initialize(); 
		if (isSDcardEjected()) {
...
//		finish();
	...
	private void setActivityResult(final int position) {
		...
		mCurrrentActiveDialog = new AlertDialog.Builder(this).setMessage(
				...
				R.string.button_ok, new OnClickListener() {
...
//						finish();
	...
	private void setPlayList() {
		...
		mCurrentPlayList = new ArrayList<MediaItem>();
		int i = 0;
...
//			startActivityForResult(intent, INTENT_TERMINATED);
	...
	private void showRenameDialog(final int position) {
		...
		OnClickListener renameConfirmListener = new OnClickListener() {
			public void onClick(DialogInterface dialog, int which) {
