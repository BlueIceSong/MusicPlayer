package com.example.song.musicplayer.db;
...
public class PlayHistoryDao {
	 ...
	 */
	public PlayHistoryInfo findByHashid(String mid) {
		SQLiteDatabase db = null;
	  	Cursor cur  = null;
	 ...
	 */
	public void updateByHashid(String hashid,PlayHistoryInfo info) {
		SQLiteDatabase db  = null;
     try {
        db = helper.getWritableDatabase();
 		...
 		contentValues.put("_playedtime", info.getPlayedtime());
	 ...
	 * @param info
	 */
	public void updateByHashid(String hashid,String info) {
		SQLiteDatabase db  = null;
     try {
        db = helper.getWritableDatabase();
 		ContentValues contentValues = new ContentValues();	
