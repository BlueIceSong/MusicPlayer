...
import com.example.song.musicplayer.util.LogUtil;
...
public class GetPlayUriByHtmlActivity extends BaseActivity implements View.OnClickListener{
		...
		mWebview.setWebViewClient(new WebViewClient() {
			public boolean shouldOverrideUrlLoading(final WebView view,
				...
				if(Utils.isCheckNetAvailable(GetPlayUriByHtmlActivity.this)){
					...
					Toast.makeText(GetPlayUriByHtmlActivity.this, "网络不可用，请检查网络再试", Toast.LENGTH_SHORT).show();
